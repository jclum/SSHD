...
public class GSSAuthenticator {
    ...
    /**
     * Get the service principal name to be used.  The default is host/hostname.
     *
     * @return servicePrincipalName The principal name
     */
    ...
    /**
     * Get the location of the Kerberos keytab.  The default is defined by the JRE.
     *
     * @return keytabFile The location of the keytab
     */
